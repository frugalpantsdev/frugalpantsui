...
class Suggestions extends React.Component {
  constructor(props) {
    super(props);
        this.suggestedCards = [{category:"Gas",cards:[{url: "https://secure.bankofamerica.com/content/images/ContextualSiteGraphics/CreditCardArt/en_US/Approved_PCM/8cty_cshsigcm_v_250x157.png",name: "Bank Of America Cash Rewards"}]},
  ...
  render() {
    return (
        ...
        <Button variant="success">Suggest which card to use</Button>
            <div className="CardSuggestion">
                <Container>
                    <Col>
                    {this.suggestedCards.map((cardResponse, i ) => {
